...
def get_hopsworks_project() -> hopsworks.project.Project:
    ...
    return hopsworks.login(
        ...
        api_key_file=config.HOPSWORKS_API_KEY
    )
...
def load_batch_of_features_from_store(current_date: datetime,) -> pd.DataFrame:
    ...
    fetch_data_from = current_date - timedelta(days=28*2)
    ...
    # validate we not missing data in the feature store
